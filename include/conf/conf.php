...
//Email
define("EMAIL_FEEDBACK", "feedback@pharma.local");
define("EMAIL_NO_REPLY", "noreply@pharma.local");
define("EMAIL_INFO", "noreply@pharma.local");
define("EMAIL_SUPPORT", "noreply@pharma.local");


define("WEB_URL", "http://pharma.local");
define("ADMIN_URL", "http://pharma.local/admin");
define("WEB_NAME", "pharma.local");
define("ORG_NAME", "pHaRmA");
